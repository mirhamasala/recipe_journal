...
var activateSwitchMode = function activateSwitchMode() {
  ...
  var switchColor = function switchColor(event) {
    ...
    if (event.currentTarget.classList.contains('light')) {
      ...
      console.log(event.currentTarget.dataset.dark);
      document.documentElement.style.setProperty('background-image', event.currentTarget.dataset.dark);
    } else {
...
/******/ });
//# sourceMappingURL=application-56cb0e4a1d3a2118264b.js.map