...
/***/ "./app/javascript/components/set_active_color.js":
/*!*******************************************************!*\
  !*** ./app/javascript/components/set_active_color.js ***!
  \*******************************************************/
...
var setActiveColor = function setActiveColor() {
  var activeColor = JSON.parse(localStorage.getItem('activeColor')) || 'light';
  var switchMode = document.querySelector('#js-color-mode');
  ...
  if (activeColor === 'dark') {
    ...
    document.documentElement.style.setProperty('--text-color', 'var(--white)');
    document.body.style.backgroundImage = "url(".concat(switchMode.dataset.dark, "?").concat(new Date().getTime(), ")");
  } else {
    switchMode.classList.add('light');
    switchMode.classList.remove('dark');
    document.documentElement.style.setProperty('--text-color', 'var(--black)');
    document.body.style.backgroundImage = "url(".concat(switchMode.dataset.light, "?").concat(new Date().getTime(), ")");
  }
};
...
/* harmony import */ var _components_set_active_color__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/set_active_color */ "./app/javascript/components/set_active_color.js");
// import 'bootstrap';


Object(_components_color_mode__WEBPACK_IMPORTED_MODULE_0__["activateSwitchMode"])();
document.addEventListener('DOMContentLoaded', function (event) {
  Object(_components_set_active_color__WEBPACK_IMPORTED_MODULE_1__["setActiveColor"])();
});
...
/******/ });
//# sourceMappingURL=application-3c2d448ac562789b60a2.js.map